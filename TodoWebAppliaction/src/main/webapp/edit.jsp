...
<% String a=request.getParameter("id");
 ...
 <div class="container-fluid pt-5">
  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
            <h1 class="card-title fw-bold text-dark" style="text-align: center;">Update TODO</h1>
      <div class="card-body">
...
<div class="form-floating">
  <input class="form-control" type="text" name="description" value=<%=description %>  required placeholder="Leave a Description here" id="floatingTextarea2" style="height: 100px">
  ...
  <label class="form-check-label" id="1" for="inlineRadio1">Unstarted</label>
</div>
<div class="form-check form-check">
  <input class="form-check-input" id="2"  required type="radio" name="status"   value="Ongoing">
  <label class="form-check-label" for="inlineRadio2">Ongoing</label>
</div>
<div class="form-check form-check">
  <input class="form-check-input" id="3"  required type="radio" name="status"   value="Finished">
...
<div class="col-md-3  d-flex justify-content-center align-items-center align-content-center">
    ...
    <input type="date" class="form-control m-2" name="date"  value=<%=date %> id="inputZip">
  </div> 
<input type="submit" value="save" class="btn btn-primary fw-bold mt-3" >     
 ...
 <div class="social">
  ...
  <script> 
  var valueFromDatabase ='<%=status%>'; 
    var radioButton = document.querySelector('input[value="' + valueFromDatabase + '"]'); 
    if (radioButton) {
