  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <h1 class="card-title fw-bold " style="text-align: center; color: #009999;">Welcome to TODO Application</h1>
  <div class="container">
                 <p class="fs-3  fw-semibold card-text"> "Unlock Your Potential with TODO App: Where Task Management Meets Simplicity. We're dedicated to streamlining your day, making productivity effortless, and ensuring you stay organized with ease."</p>
         
         </div>        
     <div class="btnspace d-grid gap-2 mt-4  d-flex justify-content-center">
  <button class="btn btn-primary"   style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: 1rem;"
  type="button"><a href="./login.jsp">Login</a></button>
  <button class="btn btn-primary" type="button"   style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: 1rem;">
  <a href="./registration.jsp">Signup</a></button>
</div>
<div class="d-flex flex-row mt-2 align-content-center justify-content-center">
...
<span role="button"  style="font-size: .75rem"tabindex="0"><a  href="./registration.jsp" >Register Todo</a></span>
	...
	<div class="container  text-center"><h1 id="service" style="color: #009999">SERVICES</h1></div>
  <div class="row gy-5">
    <div class="col-10">
      <div class="p-3">
  ...
  <div class="row g-0">
	...
	<div class="container   text-center"><h1 id="about" style="color: #009999">ABOUT US</h1></div>
